...
<!-- SVG work for the Romeo and Juliet project by Aania Khalid and Avi Zilberman -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:result-document href="../docs/images/lines_per_scene.svg">
