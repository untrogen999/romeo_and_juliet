...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="barScale" select="4"/>
                    ...
                    <svg width="{$xLength + $xSpacer + 300}" height="{$chartBottom + 400}" overflow="scroll">
                       ...
                       <g font-family="sans-serif" alignment-baseline="baseline" transform="translate(150, 150)">
                           <g>
                               ...
                               <text x="{$xMiddle}" y="-100" font-size="26" text-anchor="middle" font-weight="bold" text-decoration="underline">Speeches per Character Across <tspan font-style="italic">Romeo and Juliet</tspan> Play</text>
                           ...
                           <xsl:for-each select="distinct-values($playFile//speaker/@char)">
                               ...
                               <g font-size="12" text-anchor="middle" dominant-baseline="middle" transform="translate(0, {$yPos})">
                                   ...
                                   <text x="{$xLength}" y="0" font-size="18"><xsl:value-of select="$speechCount"/></text>
                               </g>
                           </xsl:for-each>
                       </g>
                    </svg>
